...
void main() {
  runApp( employeeMembershipView('123'));
}

class employeeMembershipView extends StatelessWidget {
  String docId;
  employeeMembershipView(this.docId);
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MembershipViewsScreen(this.docId),
    );
  }
}
...
class MembershipViewsScreen extends StatelessWidget {
  String docId;
  MembershipViewsScreen(this.docId);
